(function () {
    ...
    var ReceivedAcornsController = function ($scope, $cookies, ReceivedAcornsService, Resources) {
    ...
    ReceivedAcornsController.$inject = ['$scope', '$cookies', 'ReceivedAcornsService', 'Resources'];
    ...
    angular.module('myApp.components.receivedAcorns', [])
        ...
        .controller('ReceivedAcornsController', ReceivedAcornsController)
})();