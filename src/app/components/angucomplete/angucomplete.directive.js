/**
 * Created by vytautassugintas on 28/04/16.
 */
/**
 * Angucomplete
...
angular.module('angucomplete', [])
    .directive('angucomplete', function ($parse, $http, $sce, $timeout) {
        return {
            ...
            templateUrl: 'app/components/angucomplete/angucomplete.html',
            ...
            link: function ($scope, elem, attrs) {
                ...
                $scope.selectResult = function (result) {
                    ...
                    $scope.searchStr = $scope.lastSearchTerm = result.description;
    ...
    .controller('AngucompleteController', function ($scope, $timeout) {
